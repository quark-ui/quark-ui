...
var Popover = (_temp$5 = _class$5 = function (_PureComponent) {
  ...
  createClass(Popover, [{
    ...
    value: function render() {
      ...
      var poptitle = title ? React.createElement(
        'p',
      ...
      var button = hasButton ? React.createElement(
        'a',
      ...
      var popoverProp = {
        ...
        popup: React.createElement(
          'div',
          { className: stylename },
          React.createElement('div', { className: styles$3['popover--popup--arrow'] }),
          React.createElement(
            'div',
  ...
  return Popover;
}(PureComponent), _class$5.displayName = 'Popover', _class$5.defaultProps = {
  title: '',
  action: 'hover',
  placement: 'top',
  hasButton: false,
...
var Popconfirm = (_temp = _class = function (_PureComponent) {
    ...
    value: function render() {
      ...
      var popcontent = {
        ...
        popup: React.createElement(
          'div',
          { className: stylename },
          React.createElement('div', { className: styles$4['popconfirm--popup--arrow'] }),
          React.createElement(
            'div',
  ...
  return Popconfirm;
}(PureComponent), _class.displayName = 'Popconfirm', _class.defaultProps = {
  action: 'hover',
  placement: 'top',
  content: '',
