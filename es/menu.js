...
var Menu = (_dec = CSSModules(styles, { allowMultiple: allowMultiple }), _dec(_class = (_temp = _class2 = function (_PureComponent) {
  ...
  createClass(Menu, [{
    ...
    value: function render() {
      ...
      return _react.createElement(RcMenu, _extends$3({}, this.props, props));
    }
  }]);
  return Menu;
}(PureComponent), _class2.SubMenu = index_6, _class2.Item = index_5, _class2.ItemGroup = index_2, _class2.displayName = 'Menu', _class2.defaultProps = {
  // className: '',
  type: 'inline',
  colorType: 'warm',
  selectedKeys: [],
