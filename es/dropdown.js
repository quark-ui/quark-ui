import React$1, { Children, PureComponent, cloneElement } from 'react';
...
var Trigger = (_temp$1 = _class$1 = function (_PureComponent) {
  ...
  return Trigger;
}(PureComponent), _class$1.displayName = 'Trigger', _class$1.defaultProps = {
  action: 'hover',
  placement: ['tl', 'bl'],
  offset: [0, 0],
  popup: '',
...
var Menu = (_temp$5 = _class$5 = function (_PureComponent) {
  ...
  return Menu;
}(PureComponent), _class$5.displayName = 'Menu', _class$5.defaultProps = {}, _class$5.propTypes = {}, _temp$5);
var Item = (_temp2$1 = _class2$2 = function (_PureComponent2) {
  ...
  return Item;
}(PureComponent), _class2$2.displayName = 'Item', _class2$2.defaultProps = {}, _class2$2.propTypes = {}, _temp2$1);
...
var Dropdown = (_temp = _class = function (_PureComponent) {
  ...
  return Dropdown;
}(PureComponent), _class.displayName = 'Dropdown', _class.defaultProps = {
  trigger: 'click',
  overlay: undefined,
...
}(PureComponent), _class2.displayName = 'DropdownButton', _class2.defaultProps = _extends({}, Dropdown.defaultProps, {
