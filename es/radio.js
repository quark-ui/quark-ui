...
}(PureComponent), _class$2.displayName = 'CheckboxGroup', _class$2.defaultProps = {
  type: 'checkbox',
  defaultValue: [],
  options: [],
  onChange: function onChange() {}
...
var Checkbox$1 = (_temp$1 = _class$1 = function (_PureComponent) {
  ...
  return Checkbox;
}(PureComponent), _class$1.Group = CheckboxGroup, _class$1.displayName = 'Checkbox', _class$1.defaultProps = {
  prefixCls: 'checkbox',
  type: 'checkbox',
...
var RadioGroup = (_temp$3 = _class$3 = function (_PureComponent) {
  ...
  return RadioGroup;
}(PureComponent), _class$3.displayName = 'RadioGroup', _class$3.defaultProps = {
...
var RadioButton = (_temp$4 = _class$4 = function (_PureComponent) {
  ...
  createClass(RadioButton, [{
    ...
    value: function render() {
      ...
      return React.createElement(Radio$1, _extends({}, props, radioProps));
    }
  }]);
  return RadioButton;
}(PureComponent), _class$4.displayName = 'RadioButton', _class$4.defaultProps = {
...
var Radio$1 = (_temp = _class = function (_PureComponent) {
  ...
  return Radio;
}(PureComponent), _class.Group = RadioGroup, _class.Button = RadioButton, _class.displayName = 'Radio', _class.defaultProps = {
  type: 'radio',
