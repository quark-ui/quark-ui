import React$1, { PureComponent, cloneElement, createElement } from 'react';
...
var Input$1 = (_temp$1 = _class$1 = function (_PureComponent) {
  ...
  return Input;
}(PureComponent), _class$1.displayName = 'Input', _class$1.defaultProps = {
  type: 'text',
  size: 'normal',
  disabled: false,
  autosize: false,
...
var Search = (_temp2 = _class$2 = function (_PureComponent) {
  ...
  return Search;
}(PureComponent), _class$2.displayName = 'Search', _class$2.defaultProps = {
...
var Trigger = (_temp$4 = _class$5 = function (_PureComponent) {
  ...
  return Trigger;
}(PureComponent), _class$5.displayName = 'Trigger', _class$5.defaultProps = {
  action: 'hover',
  placement: ['tl', 'bl'],
  offset: [0, 0],
  popup: '',
...
var DatePane = (_temp$7 = _class$8 = function (_PureComponent) {
  ...
  return DatePane;
}(PureComponent), _class$8.displayName = 'DatePane', _class$8.defaultProps = {
  className: '',
  date: moment(),
...
var MonthPane = (_temp$8 = _class$9 = function (_PureComponent) {
  ...
  return MonthPane;
}(PureComponent), _class$9.displayName = 'MonthPane', _class$9.defaultProps = {
  className: '',
  date: moment(),
  showYearPane: function showYearPane() {},
...
var YearPane = (_temp$9 = _class$10 = function (_PureComponent) {
  ...
  return YearPane;
}(PureComponent), _class$10.displayName = 'YearPane', _class$10.defaultProps = {
  className: '',
  date: moment(),
...
var DecadePane = (_temp$10 = _class$11 = function (_PureComponent) {
  ...
  return DecadePane;
}(PureComponent), _class$11.displayName = 'DecadePane', _class$11.defaultProps = {
  className: '',
  date: moment(),
...
var Picker = (_temp$3 = _class$4 = function (_PureComponent) {
  ...
  return Picker;
}(PureComponent), _class$4.displayName = 'Picker', _class$4.defaultProps = {
  date: moment(),
...
var DatePicker$1 = (_temp = _class = function (_PureComponent) {
  ...
  return DatePicker;
}(PureComponent), _class.displayName = 'DatePicker', _class.defaultProps = objectAssign$1({}, defaultProps, {
  pickerType: 'date',
  disabledDate: function disabledDate() {}
...
var MonthPicker = (_temp$12 = _class$13 = function (_PureComponent) {
  ...
  return MonthPicker;
}(PureComponent), _class$13.displayName = 'MonthPicker', _class$13.defaultProps = objectAssign$1({}, defaultProps, {
  format: 'YYYY-MM'
...
var RangePicker = (_temp$13 = _class$14 = function (_PureComponent) {
  ...
  return RangePicker;
}(PureComponent), _class$14.displayName = 'RangePicker', _class$14.defaultProps = objectAssign$1({}, defaultProps, {
  fieldWidth: 100
