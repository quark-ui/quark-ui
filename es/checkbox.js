 ...
 * @author grootfish
 */
var CheckboxGroup = (_temp$1 = _class$1 = function (_PureComponent) {
...
}(PureComponent), _class$1.displayName = 'CheckboxGroup', _class$1.defaultProps = {
  type: 'checkbox',
  defaultValue: [],
  options: [],
  onChange: function onChange() {}
 ...
 * @author grootfish
 */
var Checkbox$1 = (_temp = _class = function (_PureComponent) {
  ...
  createClass(Checkbox, [{
    ...
    value: function render() {
      ...
      var classString = classnames(styles[prefixCls], (_classNames = {}, defineProperty(_classNames, styles[prefixCls + '__checked'], checked), defineProperty(_classNames, styles[prefixCls + '__disabled'], disabled), _classNames));
      var wrapperString = classnames((_classNames2 = {}, defineProperty(_classNames2, styles[prefixCls + '--wrapper'], true), defineProperty(_classNames2, styles[prefixCls + '--wrapper__checked'], checked), defineProperty(_classNames2, styles[prefixCls + '--wrapper__disabled'], disabled), _classNames2));
      var innerString = classnames(defineProperty({}, styles[prefixCls + '--inner'], true));
      return React.createElement(
        'label',
        {
          htmlFor: name,
        ...
        React.createElement(
          ...
          React.createElement('span', { className: innerString })
        ),
  ...
  return Checkbox;
}(PureComponent), _class.Group = CheckboxGroup, _class.displayName = 'Checkbox', _class.defaultProps = {
  prefixCls: 'checkbox',
  type: 'checkbox',
...
export { CheckboxGroup };export default Checkbox$1;
