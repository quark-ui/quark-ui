...
var Tab = (_temp$1 = _class$1 = function (_PureComponent) {
  ...
  createClass(Tab, [{
    ...
    value: function render() {
      ...
      var delIcon = React.createElement(Icon, { size: 12, name: 'close', onClick: this.deleteButton });
  ...
  return Tab;
}(PureComponent), _class$1.displayName = 'Tab', _class$1.defaultProps = {
  closable: true,
  tabKey: null,
...
var Tabs$1 = (_temp = _class = function (_PureComponent) {
  ...
  this.getPanel = function () {
    ...
    Children.forEach(_this2.state.children, function (children, index) {
      ...
      tab.push(React.createElement(Tab, _extends({}, tabProps, selfProps)));
