...
var Tab = (_dec$1 = CSSModules(styles$1, { allowMultiple: allowMultiple }), _dec$1(_class$1 = (_temp$1 = _class2$1 = function (_PureComponent) {
  ...
  return Tab;
}(PureComponent), _class2$1.displayName = 'Tab', _class2$1.defaultProps = {
  closable: true
}, _class2$1.propTypes = {
...
var Tabs$1 = (_dec = CSSModules(styles$1, { allowMultiple: allowMultiple }), _dec(_class = (_temp = _class2 = function (_PureComponent) {
  ...
  return Tabs;
}(PureComponent), _class2.displayName = 'Tabs', _class2.defaultProps = {
  defaultActiveKey: 0,
  type: 'line',
  size: 'default',
  tabPosition: 'top'
  ...
  this.getPanel = function () {
    ...
    var tab = [];
    var panel = [];
    Children.forEach(_this2.state.children, function (children, index$$1) {
      // add tabs
      var status = void 0,
          className = void 0;
