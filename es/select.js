...
var OptGroup = (_temp$5 = _class$5 = function (_PureComponent) {
  ...
  return OptGroup;
}(PureComponent), _class$5.displayName = 'Option', _class$5.defaultProps = {
  children: null,
  label: ''
}, _class$5.propTypes = {
...
var Select = (_temp = _class = function (_PureComponent) {
  ...
  return Select;
}(PureComponent), _class.displayName = 'Select', _class.OptGroup = OptGroup, _class.Option = Option, _class.defaultProps = {
  placeholder: '请选择',
  type: 'dropdown',
  style: { width: 200 },
  disabled: false,
