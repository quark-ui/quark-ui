...
var Breadcrumb$1 = (_dec = CSSModules(styles$1, { allowMultiple: allowMultiple }), _dec(_class = (_temp = _class2 = function (_PureComponent) {
  ...
  createClass(Breadcrumb, [{
    ...
    value: function onBack() {
      ...
      React$1.Children.map(children, function (ele, index$$1) {
    ...
    value: function render() {
      ...
      var crumbs = React$1.Children.map(children, function (ele, index$$1) {
        if (!ele) {
          return ele;
        }

        return cloneElement(ele, { separator: separator, key: index$$1 });
      });
