...
describe('Menu-test-describe----------', () => {
  ...
  it('Menu of horizontal-h warm', () => {
    ...
    expect(menu.find('li.menu-item')).to.have.length(5); // 5个菜单项
  ...
  it('Menu of vertical-v cold', () => {
    ...
    expect(menu.findWhere(n => n.name() === 'li' && n.text() === '二级菜单1')).to.have.length(1);
    expect(menu.findWhere(n => n.name() === 'li' && n.text() === '二级菜单2')).to.have.length(1);
    expect(menu.findWhere(n => n.name() === 'li' && n.text() === '二级菜单3')).to.have.length(1);
  });
