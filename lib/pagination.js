...
var Pagination = (_temp = _class = function (_PureComponent) {
  ...
  createClass(Pagination, [{
    ...
    value: function renderItems() {
      ...
      if (start !== firstPage + 1 && start !== firstPage) {
        items.push(React__default.createElement(
          ...
          React__default.createElement(Icon, { name: 'ellipsis', size: 12 })
        ));
      }
    ...
    value: function renderControl(direction) {
      ...
      var content = void 0;
      if (direction === 'prev') {
        content = React__default.createElement(Icon, { name: 'double-arrow-left', size: 12 });
      } else {
        content = React__default.createElement(Icon, { name: 'double-arrow-right', size: 12 });
      }
      return React__default.createElement(
        'button',
        ctrlProps,
    ...
    value: function renderQuickJumper() {
      ...
      if (showQuickJumper) {
        return React__default.createElement(
          ...
          '\u8DF3\u81F3 ',
          React__default.createElement('input', textFieldProps),
          ' \u9875'
        );
      }
      return null;
  ...
  return Pagination;
}(React.PureComponent), _class.displayName = 'Pagination', _class.defaultProps = {
  current: undefined,
  defaultCurrent: 1,
  total: 0,
  pageSize: undefined,
