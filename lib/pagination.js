...
var Icon = (_temp$1 = _class$1 = function (_PureComponent) {
  ...
  createClass(Icon, [{
    ...
    value: function render() {
      ...
      var svgProps = _extends({
        ...
        className: index$3(className, styles$1.Icon),
        'aria-hidden': true
      }, otherProps);
  ...
  return Icon;
}(_react.PureComponent), _class$1.displayName = 'Icon', _class$1.defaultProps = {
  name: '',
  size: 32,
...
var Pagination = (_dec = CSSModules(styles, { allowMultiple: allowMultiple }), _dec(_class = (_temp = _class2 = function (_PureComponent) {
  ...
  createClass(Pagination, [{
    ...
    value: function getItemProps(index$$1) {
      ...
      return {
        styleName: index$3('pagination__item', {
    ...
    value: function renderControl(direction) {
      var ctrlProps = {
        styleName: index$3('pagination__ctrl'),
  ...
  return Pagination;
}(_react.PureComponent), _class2.displayName = 'Pagination', _class2.defaultProps = {
  current: undefined,
  defaultCurrent: 1,
  total: 0,
  pageSize: undefined,
