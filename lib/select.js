...
var Icon = (_temp$1 = _class$1 = function (_PureComponent) {
  ...
  return Icon;
}(React.PureComponent), _class$1.displayName = 'Icon', _class$1.defaultProps = {
  name: '',
  size: 32,
...
var Animation = (_temp$4 = _class$4 = function (_PureComponent) {
  ...
  return Animation;
}(React.PureComponent), _class$4.displayName = 'Animation', _class$4.defaultProps = {
  duration: 500,
  motion: 'fade',
...
var Trigger = (_temp$2 = _class$2 = function (_PureComponent) {
  ...
  return Trigger;
}(React.PureComponent), _class$2.displayName = 'Trigger', _class$2.defaultProps = {
  action: 'hover',
  placement: ['tl', 'bl'],
  offset: [0, 0],
  popup: '',
...
var OptGroup = (_temp$5 = _class$5 = function (_PureComponent) {
  ...
  return OptGroup;
}(React.PureComponent), _class$5.displayName = 'Option', _class$5.defaultProps = {
  children: null,
  label: ''
}, _class$5.propTypes = {
...
var Option = (_temp2 = _class$6 = function (_Component) {
  ...
  return Option;
}(React.Component), _class$6.displayName = 'Option', _class$6.defaultProps = {
  value: '',
  text: undefined,
  children: null
}, _class$6.propTypes = {
...
var Select = (_temp = _class = function (_PureComponent) {
  ...
  createClass(Select, [{
    ...
    value: function render() {
      ...
      if (type === 'dropdown') {
        // 简单下位
        if (this.state.text) {
          selection = React__default.createElement(
            'span',
            null,
            this.state.text
          );
        ...
        selection = React__default.createElement('input', {
          type: 'text',
      ...
      return React__default.createElement(
        ...
        React__default.createElement(
          ...
          React__default.createElement(
            ...
            this.state.value ? React__default.createElement(Icon, {
              name: 'close',
              size: 14,
  ...
  return Select;
}(React.PureComponent), _class.displayName = 'Select', _class.OptGroup = OptGroup, _class.Option = Option, _class.defaultProps = {
  placeholder: '请选择',
  type: 'dropdown',
  style: { width: 200 },
  disabled: false,
