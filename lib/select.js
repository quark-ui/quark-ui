...
var Animation = (_temp$4 = _class$4 = function (_PureComponent) {
  ...
  return Animation;
}(React$1.PureComponent), _class$4.displayName = 'Animation', _class$4.defaultProps = {
  duration: 500,
  motion: 'fade',
...
var Trigger = (_dec = CSSModules(styles$1, { allowMultiple: allowMultiple }), _dec(_class$2 = (_temp$2 = _class2 = function (_PureComponent) {
  ...
  return Trigger;
}(React$1.PureComponent), _class2.displayName = 'Trigger', _class2.defaultProps = {
  action: 'hover',
  placement: ['tl', 'bl'],
  offset: [0, 0],
  popup: '',
...
var OptGroup = (_temp$5 = _class$5 = function (_PureComponent) {
  ...
  return OptGroup;
}(React$1.PureComponent), _class$5.displayName = 'Option', _class$5.defaultProps = {
  children: null,
  label: ''
}, _class$5.propTypes = {
...
var Option = (_temp2 = _class$6 = function (_PureComponent) {
  ...
  return Option;
}(React$1.PureComponent), _class$6.displayName = 'Option', _class$6.defaultProps = {
  value: '',
  title: undefined,
  children: null
}, _class$6.propTypes = {
...
var Select = (_temp = _class = function (_PureComponent) {
  ...
  createClass(Select, [{
    ...
    value: function render() {
      ...
      if (disabled$$1) {
        return React$1__default.createElement(
          ...
          React$1__default.createElement(
            ...
            this.state.title || React$1__default.createElement(
              'span',
      ...
      if (type === 'dropdown') {
        // 简单下位
        selection$$1 = this.state.title || React$1__default.createElement(
          'span',
          { className: styles$3.placeholder },
          this.props.placeholder
        );
      } else if (type === 'combobox') {
        selection$$1 = React$1__default.createElement('input', {
          type: 'text',
      ...
      return React$1__default.createElement(
        ...
        React$1__default.createElement(
          ...
          {
            action: 'click',
            popup: React$1__default.createElement(
              'div',
          ...
          React$1__default.createElement(
            ...
            this.state.value ? React$1__default.createElement(Icon, {
              name: 'close',
              size: 14,
  ...
  return Select;
}(React$1.PureComponent), _class.displayName = 'Select', _class.OptGroup = OptGroup, _class.Option = Option, _class.defaultProps = {
  placeholder: '请选择',
  type: 'dropdown',
  style: { width: 200 },
  disabled: false,
