...
function factory(ReactComponent, isValidElement, ReactNoopUpdateQueue) {
  ...
  index$4(ReactClassComponent.prototype, ReactComponent.prototype, ReactClassMixin);
...
var TabPane = index$3({
  ...
  render: function render() {
    ...
    var cls = index$6((_classnames = {}, _defineProperty(_classnames, prefixCls, 1), _defineProperty(_classnames, prefixCls + '-inactive', !active), _defineProperty(_classnames, prefixCls + '-active', active), _defineProperty(_classnames, className, className), _classnames));
...
var Tabs$2 = function (_React$Component) {
  ...
  _createClass(Tabs, [{
    ...
    value: function getNextActiveKey(next) {
      ...
      var children = [];
      React$1__default.Children.forEach(this.props.children, function (c) {
    ...
    value: function render() {
      ...
      var cls = index$6((_classnames = {}, _defineProperty(_classnames, prefixCls, 1), _defineProperty(_classnames, prefixCls + '-' + tabBarPosition, 1), _defineProperty(_classnames, className, !!className), _classnames));
...
var TabContent = index$3({
  ...
  render: function render() {
    ...
    var classes = index$6((_classnames = {}, _defineProperty(_classnames, prefixCls + '-content', true), _defineProperty(_classnames, animated ? prefixCls + '-content-animated' : prefixCls + '-content-no-animated', true), _classnames));
    if (animated) {
...
var _classnames3 = _interopRequireDefault(index$6);
...
var _classnames6 = _interopRequireDefault(index$6);
...
var _createReactClass2 = _interopRequireDefault(index$3);
...
var _propTypes2 = _interopRequireDefault(index$7);
...
var Icon = (_temp$1 = _class$1 = function (_PureComponent) {
  ...
  createClass$1(Icon, [{
    ...
    value: function render() {
      ...
      var svgProps = _extends$2({
        ...
        className: index$6(className, styles.Icon),
        'aria-hidden': true
      }, otherProps);
  ...
  return Icon;
}(React$1.PureComponent), _class$1.displayName = 'Icon', _class$1.defaultProps = {
  name: '',
  size: 32,
...
var _hoistNonReactStatics2 = _interopRequireDefault(index$10);
 ...
 * // => { 'a': 1, 'c': 3 }
 */
var assign$4 = _createAssigner(function(object, source) {
...
var CSSModules = unwrapExports(index$9);
 ...
 * @author yan
 */
var Tabs$1 = (_dec = CSSModules(styles$1, { allowMultiple: allowMultiple }), _dec(_class = (_temp = _class2 = function (_PureComponent) {
  inherits$1(Tabs, _PureComponent);

  function Tabs(props) {
    classCallCheck$1(this, Tabs);

    var _this = possibleConstructorReturn$1(this, (Tabs.__proto__ || Object.getPrototypeOf(Tabs)).call(this, props));
  ...
  createClass$1(Tabs, [{
    ...
    value: function render() {
      ...
      var cls = index$6((_classNames = {}, defineProperty$6(_classNames, prefixCls + '-small', size === 'small'), defineProperty$6(_classNames, prefixCls + '-card', type.indexOf('card') >= 0), defineProperty$6(_classNames, prefixCls + '-' + type, true), _classNames));
      ...
      if (type === 'edit-card') {
        React.Children.forEach(children, function (child, index) {
          ...
          childrenNodes.push(React$1.cloneElement(child, {
  ...
  return Tabs;
}(React$1.PureComponent), _class2.TabPane = TabPane, _class2.displayName = 'Tabs', _class2.defaultProps = {
  prefixCls: 'rc-tabs',
  size: 'default'
}, _class2.propTypes = {
  prefixCls: PropTypes.string,
