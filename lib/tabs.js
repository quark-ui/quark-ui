...
var reactTappable = _interopDefault(require('react-tappable'));
 ...
 * @author yan
 */
var Tab = (_dec$1 = CSSModules(styles$1, { allowMultiple: allowMultiple }), _dec$1(_class$1 = (_temp$1 = _class2$1 = function (_PureComponent) {
  ...
  createClass(Tab, [{
    ...
    value: function render() {
      ...
      var tabClass = index((_classNames = {}, defineProperty(_classNames, 'disabled', disabled$$1 === true), defineProperty(_classNames, 'active', status === 'active'), defineProperty(_classNames, 'tabs__tab', true), _classNames));
  ...
  return Tab;
}(React$1.PureComponent), _class2$1.displayName = 'Tab', _class2$1.defaultProps = {
  closable: true
}, _class2$1.propTypes = {
...
var Tabs$1 = (_dec = CSSModules(styles$1, { allowMultiple: allowMultiple }), _dec(_class = (_temp = _class2 = function (_PureComponent) {
  ...
  createClass(Tabs, [{
    ...
    value: function render() {
      ...
      var cls = index((_classNames = {}, defineProperty(_classNames, 'tabs__card', type === 'card'), defineProperty(_classNames, 'tabs__button', type === 'button'), defineProperty(_classNames, 'tabs__small', size === 'small'), defineProperty(_classNames, 'tabs__left clearfix', tabPosition === 'left'), defineProperty(_classNames, 'tabs__wrap', true), _classNames));
  ...
  return Tabs;
}(React$1.PureComponent), _class2.displayName = 'Tabs', _class2.defaultProps = {
  defaultActiveKey: 0,
  type: 'line',
  size: 'default',
  tabPosition: 'top'
  ...
  this.getPanel = function () {
    ...
    var tab = [];
    var panel = [];
    React$1.Children.forEach(_this2.state.children, function (children, index$$1) {
      // add tabs
      var status = void 0,
          className = void 0;

      status = index$$1 === that.state.activeKey ? 'active' : 'inactive';
      ...
      tab.push(React$1__default.createElement(Tab, props));

      if (index$$1 === that.state.activeKey) {
        var props = { className: index('tabs__panel', status), status: status, key: index$$1 };
        if (that.state.panelUpdateKey === index$$1) {
          props.update = true;
        }
        panel.push(React$1.cloneElement(children, props));
      }
    });
