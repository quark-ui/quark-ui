 ...
 * @author yan
 */
var Tab = (_temp$1 = _class$1 = function (_PureComponent) {
  ...
  createClass(Tab, [{
    ...
    value: function render() {
      ...
      var tabClass = classnames((_classNames = {}, defineProperty(_classNames, styles$1.disabled, disabled === true), defineProperty(_classNames, styles$1.active, status === 'active'), defineProperty(_classNames, styles$1.tabs__tab, true), _classNames));

      var delIcon = React__default.createElement(Icon, { size: 12, name: 'close', onClick: this.deleteButton });
      ...
      return React__default.createElement(
        ...
        title,
        tabDeleteButton && closable ? React__default.createElement(
          'div',
          { className: styles$1.tab__del },
          delIcon
        ) : null
      );
    }
  ...
  return Tab;
}(React.PureComponent), _class$1.displayName = 'Tab', _class$1.defaultProps = {
  closable: true,
  tabKey: null,
 ...
 * @author yan
 */
var Tabs$1 = (_temp = _class = function (_PureComponent) {
  ...
  createClass(Tabs, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(
        ...
        React__default.createElement(
          'div',
          { className: styles$1.tabs__bar },
          opt.tab
        ),
        React__default.createElement(
          'div',
          { className: styles$1.tabs__con },
          opt.panel
        )
      );
    }
  ...
  return Tabs;
}(React.PureComponent), _class.Panel = Panel, _class.displayName = 'Tabs', _class.defaultProps = {
  defaultActiveKey: 0,
  type: 'line',
  size: 'default',
  tabPosition: 'top'
  ...
  this.getPanel = function () {
    ...
    React.Children.forEach(_this2.state.children, function (children, index) {
      // add tabs
      ...
      tab.push(React__default.createElement(Tab, _extends({}, tabProps, selfProps)));
      ...
      if (index === activeKey) {
        ...
        panel.push(React.cloneElement(children, panelProps));
      }
    });
