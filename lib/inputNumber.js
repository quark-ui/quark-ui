...
var Touchable = function (_React$Component) {
    ...
    _createClass(Touchable, [{
        ...
        value: function callChildEvent(event, e) {
            var childHandle = React$1__default.Children.only(this.props.children).props[event];
            if (childHandle) {
                childHandle(e);
            }
        }
        ...
        value: function render() {
            ...
            if (!disabled && this.state.active) {
                ...
                return React$1__default.cloneElement(child, index$2({
                    className: className,
                    style: style
                }, events));
            }
...
var InputNumber = (_temp = _class = function (_PureComponent) {
  ...
  return InputNumber;
}(React$1.PureComponent), _class.displayName = 'InputNumber', _class.defaultProps = {
  step: 1,
  size: 'normal'
}, _class.propTypes = {
  min: PropTypes.number,
