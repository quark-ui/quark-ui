...
var Message = (_temp = _class$1 = function (_PureComponent) {
    ...
    value: function render() {
      ...
      return React__default.createElement(
        ...
        React__default.createElement(
          ...
          React__default.createElement(Icon, { name: type, size: 14 })
        ),
        React__default.createElement(
          'div',
  ...
  return Message;
}(React.PureComponent), _class$1.displayName = 'Message', _class$1.defaultProps = {
...
var MessageBox = (_temp2 = _class = function (_PureComponent) {
  ...
  return MessageBox;
}(React.PureComponent), _class.displayName = 'MessageBox', _class.defaultProps = {}, _class.propTypes = {}, _class.newInstance = function (properties) {
  ...
  var DOM = ReactDOM;
  var messageBox = DOM.render(React__default.createElement(MessageBox, props), div);
  return {
