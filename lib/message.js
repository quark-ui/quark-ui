  ...
  createClass(Icon, [{
    ...
    value: function render() {
      ...
      var svgProps = _extends({
        ...
        className: index$5(className, styles.Icon),
        'aria-hidden': true
      }, otherProps);
...
var styles$1 = { "message--box": "Tp7nM0V", "message": "TML-oze", "message--content": "_3bIMIt4", "message--icon": "_2nJiJW2", "message__info": "_24nf85a", "message__success": "_31au0Cv", "message__error": "_34GJGIf", "message__warning": "_2oCKBQV", "message-Box": "Tp7nM0V", "message-Content": "_3bIMIt4", "message-Icon": "_2nJiJW2" };
...
var Message = (_dec$1 = CSSModules(styles$1, { allowMultiple: allowMultiple }), _dec$1(_class$1 = (_temp$1 = _class2$1 = function (_PureComponent) {
  ...
  createClass(Message, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        'div',
        { styleName: index$5('message', 'message__' + type) },
        React.createElement(
          'span',
  ...
  return Message;
}(_react.PureComponent), _class2$1.displayName = 'Message', _class2$1.defaultProps = {
...
var MessageBox = (_dec = CSSModules(styles$1, { allowMultiple: allowMultiple }), _dec(_class = (_temp = _class2 = function (_PureComponent) {
  ...
  return MessageBox;
}(_react.PureComponent), _class2.displayName = 'MessageBox', _class2.defaultProps = {}, _class2.propTypes = {}, _temp)) || _class);
