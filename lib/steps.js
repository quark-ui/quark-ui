 ...
 * @author grootfish
 */
var Step = (_temp$1 = _class$1 = function (_PureComponent) {
    ...
    value: function render() {
      ...
      if (status === 'finish' && isFinishIcon) {
        iconNode = React__default.createElement(
          ...
          React__default.createElement(Icon, { name: 'check', size: 14 })
        );
      } else {
        iconNode = React__default.createElement(
          'span',
      ...
      var classString = classnames((_classnames = {}, defineProperty(_classnames, styles['steps--item'], true), defineProperty(_classnames, styles['steps--item__' + status], true), _classnames));
      ...
      return React__default.createElement(
        ...
        React__default.createElement(
          ...
          React__default.createElement(
            'div',
            { className: styles['steps--head'] },
            React__default.createElement(
              'div',
              { className: styles['steps--headinner'] },
              iconNode
            )
          ),
          React__default.createElement(
            'div',
            { className: styles['steps--main'] },
            React__default.createElement(
              'div',
            ...
            description ? React__default.createElement(
              'div',
              { className: styles['steps--description'] },
              description
            ) : null
          )
        )
  ...
  return Step;
}(React.PureComponent), _class$1.displayName = 'Step', _class$1.defaultProps = {
  status: '',
  title: '',
  description: '',
  stepNumber: '',
  itemWidth: 0,
  adjustMarginRight: 0,
  isFinishIcon: false }, _class$1.propTypes = {
 ...
 * @author grootfish
 */
var Steps$1 = (_temp = _class = function (_PureComponent) {
  ...
  createClass(Steps, [{
    ...
    value: function render() {
      ...
      var classString = classnames((_classnames = {}, defineProperty(_classnames, styles.steps, true), defineProperty(_classnames, styles['steps__' + direction], true), defineProperty(_classnames, styles['steps__' + size], size), _classnames));
      return React__default.createElement(
        'div',
  ...
  return Steps;
}(React.PureComponent), _class.displayName = 'Steps', _class.Step = Step, _class.defaultProps = {
  direction: 'horizontal',
  current: 0,
  status: 'process',
  isFinishIcon: false,
  size: '' }, _class.propTypes = {
