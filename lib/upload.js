...
var RcUpload = _interopDefault(require('rc-upload'));
...
var Icon = (_temp$2 = _class$2 = function (_PureComponent) {
  ...
  createClass(Icon, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(IconNode, svgProps);
    }
  }]);
  return Icon;
}(React.PureComponent), _class$2.displayName = 'Icon', _class$2.defaultProps = {
  name: '',
  size: 32,
...
var Line = function Line(_ref) {
  ...
  if (showInfo) {
    switch (status) {
      case 'success':
        indicator = React__default.createElement(Icon, { name: 'success', size: 14 });
        break;
      case 'exception':
        indicator = React__default.createElement(Icon, { name: 'error', size: 14 });
        break;
      case 'pause':
        indicator = React__default.createElement(Icon, { name: 'clock', size: 14 });
        break;
      default:
        indicator = percent + '%';
        break;
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      'div',
      { className: styles$1.progress__lineOuter },
      React__default.createElement('div', innerProps)
    ),
    showInfo ? React__default.createElement(
      'span',
      { className: styles$1.progress__lineIndicator },
      indicator
    ) : null
  );
};
...
var Progress = (_temp$3 = _class$3 = function (_PureComponent) {
  ...
  createClass(Progress, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(Line, renderProps);
    }
  ...
  return Progress;
}(React.PureComponent), _class$3.displayName = 'Progress', _class$3.defaultProps = _extends({}, defaultProps), _class$3.propTypes = _extends({}, propTypes), _temp$3);
...
var UploadList = (_temp$1 = _class$1 = function (_React$Component) {
  ...
  createClass(UploadList, [{
    ...
    value: function renderListItem(file) {
      ...
      var progress = void 0;
      var icon = React__default.createElement(Icon, { size: 12, className: styles$2.status, name: file.status === 'uploading' ? 'attachment' : 'attachment' });
      ...
      if (listType === 'picture' || listType === 'picture-card') {
        if (file.status === 'uploading' || !file.thumbUrl && !file.url) {
          if (listType === 'picture-card') {
            ...
            icon = React__default.createElement(Icon, { className: prefixCls + '-list-item-thumbnail', type: 'picture' });
          }
        } else {
          icon = React__default.createElement(
            'a',
            ...
            React__default.createElement('div', { className: styles$2.imgshow, style: { backgroundImage: 'url(' + (file.thumbUrl || file.url) + ')' } })
          );
        }
      }
      ...
      if (file.status === 'uploading') {
        ...
        var loadingProgress = 'percent' in file ? React__default.createElement(Progress, _extends({ type: 'line' }, this.props.progressAttr, { percent: file.percent })) : null;

        progress = React__default.createElement(
          'div',
      ...
      var preview = file.url ? React__default.createElement(
        'a',
        {
          href: file.url,
          target: '_blank',
      ...
      var previewIcon = showPreviewIcon ? React__default.createElement(
        'a',
        {
          href: file.url || file.thumbUrl,
          target: '_blank',
        ...
        React__default.createElement(Icon, { name: 'visible', size: 20, className: styles$2.eye })
      ) : null;
      // picture-card 删除按钮
      var removeIcon = showRemoveIcon && !disabled ? React__default.createElement(
        'button',
        {
        ...
        React__default.createElement(Icon, { name: 'recycle', size: 20, className: styles$2.remove })
      ) : null;
      // text 删除按钮
      var removeIconCross = showRemoveIcon && !disabled ? React__default.createElement(
        'button',
        {
          className: styles$2['btn-remove'],
          title: locale.removeFile,
        ...
        React__default.createElement(Icon, { name: 'close', size: 10, className: styles$2.remove })
      ) : null;
      var actions = listType === 'picture-card' && file.status !== 'uploading' ? React__default.createElement(
        'span',
      ...
      var iconAndPreview = file.status === 'error' ? React__default.createElement(
        'span',
        null,
        icon,
        preview
  ...
  return UploadList;
}(React__default.Component), _class$1.displayName = 'UploadList', _class$1.defaultProps = {
...
var Upload = (_temp = _class = function (_React$Component) {
  ...
  createClass(Upload, [{
    ...
    value: function render() {
      ...
      var uploadList = showUploadList ? React__default.createElement(UploadList, {
        listType: listType,
      ...
      var uploadButton = React__default.createElement(
        'div',
        ...
        React__default.createElement(RcUpload, _extends({}, rcUploadProps, {
  ...
  return Upload;
}(React__default.Component), _class.displayName = 'Upload', _class.defaultProps = {
  name: 'file',
