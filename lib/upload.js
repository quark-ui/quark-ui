...
var Progress = (_dec$2 = CSSModules(styles$1, { allowMultiple: allowMultiple }), _dec$2(_class$3 = (_temp$3 = _class2$2 = function (_PureComponent) {
  ...
  createClass(Progress, [{
    ...
    value: function render() {
      ...
      return React$1__default.createElement(Line, renderProps);
    }
  ...
  return Progress;
}(React$1.PureComponent), _class2$2.displayName = 'Progress', _class2$2.defaultProps = _extends({}, defaultProps), _class2$2.propTypes = _extends({}, propTypes), _temp$3)) || _class$3);
    ...
    value: function render() {
      ...
      var list = items.map(function (file) {
        ...
        if (file.status === 'uploading') {
          ...
          var loadingProgress = 'percent' in file ? React$1__default.createElement(Progress, _extends({ type: 'line' }, _this3.props.progressAttr, { percent: file.percent })) : null;
...
var Upload = (_dec = CSSModules(styles$2, { allowMultiple: allowMultiple }), _dec(_class = (_temp = _class2 = function (_React$Component) {
  ...
  createClass(Upload, [{
    ...
    value: function render() {
      ...
      var uploadList$$1 = showUploadList ? React$1__default.createElement(UploadList, {
        listType: listType,
      ...
      React$1__default.createElement(
        ...
        React$1__default.createElement(RcUpload, _extends({}, rcUploadProps, { ref: 'upload' }))
      );
