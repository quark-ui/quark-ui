    ...
    value: function render() {
      if (this.props.supportServerRender) {
        ...
        if (_ComponentUploader) {
          return React$1__default.createElement(_ComponentUploader, _extends$1({}, this.props, { ref: 'inner' }));
        }
        return null;
      }
      var ComponentUploader = this.getComponent();
      return React$1__default.createElement(ComponentUploader, _extends$1({}, this.props, { ref: 'inner' }));
    }
  }]);
...
var Icon = (_temp$2 = _class$2 = function (_PureComponent) {
  ...
  return Icon;
}(React$1.PureComponent), _class$2.displayName = 'Icon', _class$2.defaultProps = {
  name: '',
  size: 32,
...
var Progress = (_dec$2 = CSSModules(styles$1, { allowMultiple: allowMultiple }), _dec$2(_class$3 = (_temp$3 = _class2$2 = function (_PureComponent) {
    ...
    value: function render() {
      ...
      if (showInfo) {
        ...
        if (progressStatus === 'exception') {
          text = format ? textFormatter(percent) : React$1__default.createElement(Icon, { size: 14, name: 'error', color: 'red' });
        } else if (progressStatus === 'success') {
          text = format ? textFormatter(percent) : React$1__default.createElement(Icon, { size: 14, name: 'success', color: 'green' });
        } else {
          text = textFormatter(percent);
        }
        progressInfo = React$1__default.createElement(
          'span',
      ...
      if (type === 'line') {
        ...
        progress = React$1__default.createElement(
          'div',
          null,
          React$1__default.createElement(
            ...
            React$1__default.createElement(
              ...
              React$1__default.createElement('div', { styleName: prefixCls + '--bg', style: percentStyle })
            )
          ),
          progressInfo
        );
  ...
  return Progress;
}(React$1.PureComponent), _class2$2.displayName = 'Progress', _class2$2.defaultProps = {
  type: 'line',
  percent: 0,
  showInfo: true,
  strokeWidth: 10,
...
var UploadList = (_dec$1 = CSSModules(styles$2, { allowMultiple: allowMultiple }), _dec$1(_class$1 = (_temp$1 = _class2$1 = function (_React$Component) {
  ...
  createClass$1(UploadList, [{
    ...
    value: function render() {
      ...
      var list = items.map(function (file) {
        var progress = void 0;
        var icon = React$1__default.createElement(Icon, { size: 12, styleName: 'status', name: file.status === 'uploading' ? 'attachment' : 'attachment' });

        if (listType === 'picture' || listType === 'picture-card') {
          if (file.status === 'uploading' || !file.thumbUrl && !file.url) {
            if (listType === 'picture-card') {
              icon = React$1__default.createElement(
                'div',
                { styleName: 'uploading-text' },
                locale.uploading
              );
            } else {
              icon = React$1__default.createElement(Icon, { className: prefixCls + '-list-item-thumbnail', type: 'picture' });
            }
          } else {
            icon = React$1__default.createElement(
              'a',
              ...
              React$1__default.createElement('img', { src: file.thumbUrl || file.url, alt: file.name, styleName: 'imgshow' })
            );
          }
        }
        ...
        if (file.status === 'uploading') {
          ...
          var loadingProgress = 'percent' in file ? React$1__default.createElement(Progress, _extends$2({ type: 'line' }, _this3.props.progressAttr, { percent: file.percent })) : null;
        ...
        var preview = file.url ? React$1__default.createElement(
          'a',
          {
            href: file.url,
            target: '_blank',
        ...
        var previewIcon = showPreviewIcon ? React$1__default.createElement(
          'a',
          {
            href: file.url || file.thumbUrl,
            target: '_blank',
          ...
          React$1__default.createElement(Icon, { name: 'visible', size: 20, styleName: 'eye' })
        ) : null;
        // picture-card 删除按钮
        var removeIcon = showRemoveIcon && !disabled ? React$1__default.createElement(
          'a',
          {
          ...
          React$1__default.createElement(Icon, { name: 'recycle', size: 20, styleName: 'remove' })
        ) : null;
        // text 删除按钮
        var removeIconCross = showRemoveIcon && !disabled ? React$1__default.createElement(
          'a',
          {
            href: 'javascript:void(0)',
            title: locale.removeFile,
          ...
          React$1__default.createElement(Icon, { name: 'close', size: 10, styleName: 'remove' })
        ) : null;
        var actions = listType === 'picture-card' && file.status !== 'uploading' ? React$1__default.createElement(
          'span',
        ...
        var iconAndPreview = file.status === 'error' ? React$1__default.createElement(
          'span',
          null,
          icon,
          preview
  ...
  return UploadList;
}(React$1__default.Component), _class2$1.displayName = 'UploadList', _class2$1.defaultProps = {
...
var Upload = (_dec = CSSModules(styles$2, { allowMultiple: allowMultiple }), _dec(_class = (_temp = _class2 = function (_React$Component) {
  ...
  createClass$1(Upload, [{
    ...
    value: function render() {
      ...
      var uploadList = showUploadList ? React$1__default.createElement(UploadList, {
        listType: listType,
      ...
      React$1__default.createElement(
        ...
        React$1__default.createElement(Upload$2, _extends$2({}, rcUploadProps, { ref: 'upload' }))
      );
      ...
      if (listType === 'picture-card') {
        return React$1__default.createElement(
          ...
          uploadList,
          uploadButton,
          React$1__default.createElement('div', { style: { clear: 'both' } })
        );
      }
      return React$1__default.createElement(
        'div',
  ...
  return Upload;
}(React$1__default.Component), _class2.displayName = 'Upload', _class2.defaultProps = {
  name: 'file',
