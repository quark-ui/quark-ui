...
var styles = { "trigger": "_2EXkxum", "trigger--wrap": "RJgC0pN", "popup": "_1xfqu0A", "trigger-Wrap": "RJgC0pN" };
...
var Popup = (_dec$2 = renderTo(), _dec2$1 = CSSModules(styles, { allowMultiple: allowMultiple }), _dec$2(_class$2 = _dec2$1(_class$2 = (_temp$2 = _class2$2 = function (_PureComponent) {
  ...
  return Popup;
}(_react.PureComponent), _class2$2.displayName = 'Popup', _class2$2.defaultProps = {
  position: [0, 0],
  popupRef: null,
  visible: false,
...
var Trigger = (_dec$1 = CSSModules(styles, { allowMultiple: allowMultiple }), _dec$1(_class$1 = (_temp$1 = _class2$1 = function (_PureComponent) {
  ...
  return Trigger;
}(_react.PureComponent), _class2$1.displayName = 'Trigger', _class2$1.defaultProps = {
  action: 'hover',
  placement: ['tl', 'bl'],
  offset: [0, 0],
  popup: '',
...
var Button = (_temp$3 = _class$3 = function (_PureComponent) {
  ...
  createClass(Button, [{
    ...
    value: function render() {
      ...
      var btnProps = _extends({}, otherProps, {
        className: index$3(styles$1['button--' + (disabled ? 'disabled' : type)], styles$1['button--' + size])
      });
      return React.createElement(
        'button',
        btnProps,
  ...
  return Button;
}(_react.PureComponent), _class$3.displayName = 'Button', _class$3.defaultProps = {
  type: 'primary',
...
var styles$2 = { "dropdown--buttonWrap": "_1eceZej", "dropdown--menuItem": "-dJrDFX", "dropdown": "zOFn225", "dropdown--menu": "_1xylRH-", "dropdown-ButtonWrap": "_1eceZej", "dropdown-MenuItem": "-dJrDFX", "dropdown-Menu": "_1xylRH-" };
  ...
  createClass(Menu, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        _react.Children.map(children, function (Comp) {
          return _react.cloneElement(Comp);
        })
      );
    }
  }]);
  return Menu;
}(_react.PureComponent), _class2$3.displayName = 'Menu', _class2$3.defaultProps = {}, _class2$3.propTypes = {
  children: PropTypes.isRequired
}, _temp$4)) || _class$4);
var Item = (_dec2$2 = CSSModules(styles$2, { allowMultiple: allowMultiple }), _dec2$2(_class3$1 = (_temp2$1 = _class4$1 = function (_PureComponent2) {
  ...
  return Item;
}(_react.PureComponent), _class4$1.displayName = 'Item', _class4$1.defaultProps = {}, _class4$1.propTypes = {
  children: PropTypes.isRequired
}, _temp2$1)) || _class3$1);
...
var Dropdown = (_dec = CSSModules(styles$2, { allowMultiple: allowMultiple }), _dec(_class = (_temp = _class2 = function (_PureComponent) {
  ...
  return Dropdown;
}(_react.PureComponent), _class2.displayName = 'Dropdown', _class2.defaultProps = {
  trigger: 'click',
  overlay: undefined,
...
}(_react.PureComponent), _class4.displayName = 'DropdownButton', _class4.defaultProps = _extends({}, Dropdown.defaultProps, {
