...
var Alert = (_temp = _class = function (_PureComponent) {
  ...
  createClass(Alert, [{
    ...
    value: function render() {
      ...
      return this.state.closed ? null : React__default.createElement(
        'div',
        { className: alertCls },
        showIcon ? React__default.createElement(Icon, { className: styles$1['alert--icon'], name: type, size: 18 }) : null,
        React__default.createElement(
          'span',
        ...
        closable ? React__default.createElement(
          ...
          closeText || React__default.createElement(Icon, { name: 'close', size: 14 })
        ) : null
      );
    }
  }]);
  return Alert;
}(React.PureComponent), _class.displayName = 'Alert', _class.defaultProps = {
  type: 'info',
  closable: false,
  showIcon: false,
  closeText: '',
