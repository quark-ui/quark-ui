...
var Alert = (_dec = CSSModules(styles$1, { allowMultiple: allowMultiple }), _dec(_class = (_temp = _class2 = function (_PureComponent) {
  ...
  createClass(Alert, [{
    ...
    value: function render() {
      ...
      var alertCls = index((_classnames = {
        alert: true
      }, defineProperty(_classnames, 'alert__' + type, true), defineProperty(_classnames, 'with-description', !!description), defineProperty(_classnames, 'no-icon', !showIcon), _classnames));
  ...
  return Alert;
}(react.PureComponent), _class2.displayName = 'Alert', _class2.defaultProps = {
  type: 'info',
  closable: false,
  showIcon: false,
  closeText: '',
