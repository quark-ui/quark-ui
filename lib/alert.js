...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__icon__ = __webpack_require__(21);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Alert_css__ = __webpack_require__(131);
...
function noop() {}
var Alert = (_dec = __WEBPACK_IMPORTED_MODULE_4_react_css_modules___default()(__WEBPACK_IMPORTED_MODULE_6__Alert_css___default.a, { allowMultiple: __WEBPACK_IMPORTED_MODULE_5__constants__["a" /* allowMultiple */] }), _dec(_class = (_temp = _class2 = function (_PureComponent) {
  ...
  _createClass(Alert, [{
    ...
    value: function render() {
      ...
      var alertCls = __WEBPACK_IMPORTED_MODULE_2_classnames___default()((_classnames = {}, _defineProperty(_classnames, 'alert', true), _defineProperty(_classnames, 'alert__' + type, true), _defineProperty(_classnames, 'with-description', !!description), _defineProperty(_classnames, 'no-icon', !showIcon), _classnames));

      return this.state.closed ? null : React.createElement(
        'div',
        { styleName: alertCls },
        showIcon ? React.createElement(__WEBPACK_IMPORTED_MODULE_3__icon__["default"], { styleName: 'alert--icon', name: type, size: '18' }) : null,
        React.createElement(
          'span',
  ...
  type: 'info',
  showIcon: false,
  closeText: React.createElement(__WEBPACK_IMPORTED_MODULE_3__icon__["default"], { name: 'close', size: '14' })
}, _class2.propTypes = {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Alert__ = __webpack_require__(86);
