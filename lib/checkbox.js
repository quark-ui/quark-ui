...
}(_react.PureComponent), _class2$1.displayName = 'CheckboxGroup', _class2$1.defaultProps = {
  type: 'checkbox',
  defaultValue: [],
  optoins: [],
  onChange: function onChange() {}
...
var Checkbox$1 = (_dec = CSSModules(styles, { allowMultiple: allowMultiple }), _dec(_class = (_temp = _class2 = function (_PureComponent) {
  ...
  return Checkbox;
}(_react.PureComponent), _class2.Group = CheckboxGroup, _class2.displayName = 'Checkbox', _class2.defaultProps = {
  prefixCls: 'checkbox',
  type: 'checkbox',
