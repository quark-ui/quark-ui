...
}(React.PureComponent), _class$1.displayName = 'CheckboxGroup', _class$1.defaultProps = {
  type: 'checkbox',
  defaultValue: [],
  options: [],
  onChange: function onChange() {}
...
var Checkbox$1 = (_temp = _class = function (_PureComponent) {
  ...
  return Checkbox;
}(React.PureComponent), _class.Group = CheckboxGroup, _class.displayName = 'Checkbox', _class.defaultProps = {
  prefixCls: 'checkbox',
  type: 'checkbox',
