 ...
 * @author yanwei
 */
var Notice = (_temp$1 = _class$1 = function (_PureComponent) {
  ...
  createClass(Notice, [{
    ...
    value: function render() {
      ...
      var cls = classnames((_classnames = {}, defineProperty(_classnames, styles$1.notification, 1), defineProperty(_classnames, styles$1['notification--icon'], type || icon), _classnames));
      ...
      return React__default.createElement(
        ...
        React__default.createElement(
          'div',
          { className: styles$1['notification--content'] },
          type ? React__default.createElement(Icon, { className: classnames((_classnames2 = {}, defineProperty(_classnames2, styles$1.notification__icon, 1), defineProperty(_classnames2, styles$1['notification--icon--' + type], type), _classnames2)),
            name: type, size: 24 }) : null,
          icon || null,
          React__default.createElement(
            'div',
            { className: styles$1.notification__mes },
            props.message
          ),
          React__default.createElement(
            'div',
            { className: styles$1.notification__des },
            props.description
          ),
          btn ? React__default.createElement(
            'div',
            { className: styles$1.notification__btn },
            btn
          ) : null
        ),
        React__default.createElement(
          'span',
          {
            ...
            className: styles$1['notification--close']
          },
          React__default.createElement(Icon, { name: 'close', size: 14 })
        )
      );
    }
  }]);
  return Notice;
}(React.PureComponent), _class$1.displayName = 'Notice', _class$1.defaultProps = {
 ...
 * @author yanwei
 */
var NotificationBox = (_temp = _class = function (_PureComponent) {
  ...
  createClass(NotificationBox, [{
    ...
    value: function render() {
      ...
      var Nodes = this.state.notices.map(function (notice) {
        ...
        return React__default.createElement(Notice, _extends({}, notice, { onClose: onClose }));
      });

      var notificationProps = {
        style: style,
        className: classnames((_classnames = {}, defineProperty(_classnames, styles$1['notification--box'], 1), defineProperty(_classnames, styles$1['notification--box--' + placement], placement), _classnames))
      };
      return React__default.createElement(
        'div',
        notificationProps,
...
}(React.PureComponent), _class.displayName = 'NotificationBox', _class.defaultProps = {}, _class.propTypes = {}, _temp);
...
NotificationBox.newInstance = function newInstance(properties) {
  ...
  var DOM = ReactDOM;
  var notificationBox = DOM.render(React__default.createElement(NotificationBox, props), container);
