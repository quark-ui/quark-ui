...
var Button = (_temp$1 = _class$1 = function (_PureComponent) {
  ...
  createClass(Button, [{
    ...
    value: function render() {
      ...
      var btnProps = _extends({}, otherProps, {
        className: index$2(styles['button--' + (disabled ? 'disabled' : type)], styles['button--' + size])
      });
  ...
  return Button;
}(_react.PureComponent), _class$1.displayName = 'Button', _class$1.defaultProps = {
  type: 'primary',
...
var Mask = (_dec$1 = CSSModules(styles$1, { allowMultiple: allowMultiple }), _dec$1(_class$2 = (_temp$2 = _class2$1 = function (_Component) {
  ...
  return Mask;
}(_react.Component), _class2$1.displayName = 'Modal', _class2$1.defaultProps = {
...
var Modal = (_dec = renderTo(), _dec2 = CSSModules(styles$1, { allowMultiple: allowMultiple }), _dec(_class = _dec2(_class = (_temp = _class2 = function (_Component) {
  ...
  return Modal;
}(_react.Component), _class2.displayName = 'Modal', _class2.defaultProps = {
  title: '',
  closable: true,
  width: 520,
  visible: false,
