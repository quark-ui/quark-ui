...
var Button = (_temp$1 = _class$1 = function (_PureComponent) {
  ...
  return Button;
}(React.PureComponent), _class$1.displayName = 'Button', _class$1.defaultProps = {
  type: 'primary',
    ...
    value: function render() {
      ...
      var modalProps = {
        title: React__default.createElement(
          'p',
          null,
          React__default.createElement(Icon, { name: type, size: 26, color: colorArr[type] }),
          React__default.createElement(
            'span',
            null,
            config.title || type
          ),
          config.closable ? React__default.createElement(
            'button',
            {
            ...
            React__default.createElement(Icon, { name: 'close', size: 18, color: '#a6a6a6' })
          ) : null
        ),
        visible: visible,
        closable: false,
...
var renderNoticeModal = function renderNoticeModal(type) {
  ...
  ReactDOM.render(React__default.createElement(NoticeModal, {
    type: type,
    config: config,
    afterClose: function afterClose() {
...
var Modal = (_dec = renderTo(), _dec(_class = (_temp = _class2 = function (_Component) {
  ...
  createClass(Modal, [{
      ...
      if (hasHeader) {
        return React__default.createElement(
          ...
          closable ? React__default.createElement(
            ...
            React__default.createElement(Icon, { name: 'close', size: 18 })
          ) : null
        );
      }
      return null;
    ...
    value: function renderFooter() {
      ...
      var defaultFooter = [React__default.createElement(
        Button,
        {
          key: 'cancel',
          type: 'secondary',
      ...
      return footer === undefined ? React__default.createElement(
        'div',
  ...
  return Modal;
}(React.Component), _class2.displayName = 'Modal', _class2.defaultProps = {
  title: '',
  closable: true,
  width: 520,
  visible: false,
