...
var Progress = (_dec = CSSModules(styles, { allowMultiple: allowMultiple }), _dec(_class = (_temp = _class2 = function (_PureComponent) {
  ...
  return Progress;
}(React$1.PureComponent), _class2.displayName = 'Progress', _class2.defaultProps = _extends({}, defaultProps), _class2.propTypes = _extends({}, propTypes), _temp)) || _class);
