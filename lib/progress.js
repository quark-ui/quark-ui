...
var Line = function Line(_ref) {
  ...
  var lineProps = {
    className: classnames(styles['progress__' + (showInfo ? 'showinfo' : 'line')], styles['progress__line--' + size + 'Size'], styles['progress__line--' + status])
  };
  var innerProps = {
...
var Progress = (_temp = _class = function (_PureComponent) {
  ...
  return Progress;
}(React.PureComponent), _class.displayName = 'Progress', _class.defaultProps = _extends({}, defaultProps), _class.propTypes = _extends({}, propTypes), _temp);
