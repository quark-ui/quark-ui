...
var Input$1 = (_temp = _class = function (_PureComponent) {
  ...
  createClass(Input, [{
    ...
    value: function renderLabeledIcon(children) {
      ...
      var inputProps = {
        className: classnames(styles.input__wrapper, (_classnames = {}, defineProperty(_classnames, styles.input__wrapper__prefix, prefix), defineProperty(_classnames, styles.input__wrapper__suffix, suffix), _classnames))
      };
    ...
    value: function render() {
      ...
      var fieldProps = _extends({}, otherProps, {
        className: classnames(styles['input__' + (disabled ? 'disabled' : type)], styles['input__' + size]),
      ...
      if (type === 'textarea') {
        return React$1__default.createElement('textarea', _extends({}, fieldProps, {
          style: objectAssign({}, props.style, this.state.textareaStyles),
  ...
  return Input;
}(React$1.PureComponent), _class.displayName = 'Input', _class.defaultProps = {
  type: 'text',
  size: 'normal',
  disabled: false,
  autosize: false,
 ...
 * @author yan
 */
var Search = (_temp2 = _class$1 = function (_PureComponent) {
  ...
  return Search;
}(React$1.PureComponent), _class$1.displayName = 'Search', _class$1.defaultProps = {
