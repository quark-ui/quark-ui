...
var Input$1 = (_dec = CSSModules(styles, { allowMultiple: allowMultiple }), _dec(_class = (_temp = _class2 = function (_PureComponent) {
    ...
    value: function render() {
      ...
      if (type === 'textarea') {
        return React.createElement('textarea', _extends({}, fieldProps, {
          style: index({}, props.style, this.state.textareaStyles),
  ...
  return Input;
}(_react.PureComponent), _class2.displayName = 'Input', _class2.defaultProps = {
  type: 'text',
  size: 'normal',
  ...
  createClass(Icon, [{
    ...
    value: function render() {
      ...
      var svgProps = _extends({
        ...
        className: index$4(className, styles$1.Icon),
        'aria-hidden': true
      }, otherProps);
...
var Search = (_dec$1 = CSSModules(styles, { allowMultiple: allowMultiple }), _dec$1(_class$1 = (_temp$1 = _class2$1 = function (_PureComponent) {
  ...
  return Search;
}(_react.PureComponent), _class2$1.displayName = 'Search', _class2$1.defaultProps = {
