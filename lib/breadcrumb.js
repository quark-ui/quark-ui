...
var styles$1 = { "breadcrumb": "_26mKfx-", "breadcrumb--link": "_35am08f", "breadcrumb--separator": "_3v_bQW3", "breadcrumb--icon": "y-He0IY" };
...
var Breadcrumb$1 = (_temp = _class = function (_PureComponent) {
  ...
  createClass(Breadcrumb, [{
    ...
    value: function onBack() {
      ...
      React__default.Children.map(children, function (ele, index) {
    ...
    value: function render() {
      ...
      var crumbs = React__default.Children.map(children, function (ele, index) {
        if (!ele) {
          return ele;
        }

        return React.cloneElement(ele, { separator: separator, key: index });
      });
      ...
      return React__default.createElement(
        ...
        React__default.createElement(
          ...
          hasHomeIcon ? React__default.createElement(
            'span',
            null,
            React__default.createElement(Icon, { name: 'home', size: 12, onClick: this.onHome })
          ) : null,
          hasBackIcon ? React__default.createElement(
            'span',
            null,
            React__default.createElement(Icon, { name: 'arrow-left', size: 12, onClick: this.onBack })
          ) : null
        ),
        crumbs
      );
  ...
  return Breadcrumb;
}(React.PureComponent), _class.displayName = 'Breadcrumb', _class.defaultProps = {
  separator: '/',
  hasBackIcon: false,
...
}(React.PureComponent), _class$2.displayName = 'BreadcrumbItem', _class$2.defaultProps = {
