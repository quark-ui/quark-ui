...
var Breadcrumb$1 = (_dec = CSSModules(styles$1, { allowMultiple: allowMultiple }), _dec(_class = (_temp = _class2 = function (_PureComponent) {
  ...
  createClass(Breadcrumb, [{
    ...
    value: function onBack() {
      ...
      React$1__default.Children.map(children, function (ele, index) {
    ...
    value: function render() {
      ...
      var crumbs = React$1__default.Children.map(children, function (ele, index) {
        if (!ele) {
          return ele;
        }

        return React$1.cloneElement(ele, { separator: separator, key: index });
      });
