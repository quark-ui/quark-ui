...
var styles$1 = { "breadcrumb--icon": "lGcMH25", "breadcrumb": "_15DqQC7", "breadcrumb--separator": "_24xT_Vo", "breadcrumb--link": "_2knYGjk", "breadcrumb-Icon": "lGcMH25", "breadcrumb-Separator": "_24xT_Vo", "breadcrumb-Link": "_2knYGjk" };
...
var Breadcrumb$1 = (_dec = CSSModules(styles$1, { allowMultiple: allowMultiple }), _dec(_class = (_temp = _class2 = function (_PureComponent) {
  ...
  createClass(Breadcrumb, [{
    ...
    value: function onBack() {
      ...
      React$1__default.Children.map(children, function (ele, index$$1) {
        if (index$$1 === children.length - 2 && ele.props.href) {
    ...
    value: function render() {
      ...
      var crumbs = React$1__default.Children.map(children, function (ele, index$$1) {
        if (!ele) {
          return ele;
        }

        return React$1.cloneElement(ele, { separator: separator, key: index$$1 });
      });
      ...
      return React$1__default.createElement(
        ...
        React$1__default.createElement(
          ...
          hasHomeIcon ? React$1__default.createElement(
            'span',
            null,
            React$1__default.createElement(Icon, { name: 'home', size: 12, onClick: this.onHome })
          ) : null,
          hasBackIcon ? React$1__default.createElement(
            'span',
            null,
            React$1__default.createElement(Icon, { name: 'arrow-left', size: 12, onClick: this.onBack })
          ) : null
        ),
        crumbs
      );
  ...
  return Breadcrumb;
}(React$1.PureComponent), _class2.displayName = 'Breadcrumb', _class2.defaultProps = {
  separator: '/',
  hasBackIcon: false,
...
}(React$1.PureComponent), _class2$1.displayName = 'BreadcrumbItem', _class2$1.defaultProps = {
